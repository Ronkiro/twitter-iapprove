...
export const twitterAPIURL = 'https://api.twitter.com/1.1';
export const tweetsSearchEndpointURL = '/search/tweets.json';
...
export class TwitterService {
  ...
  searchTweets(queryString: string,
    ...
    //   `${endpointURL}?q=${queryString}&resultType=${resultType}&count=${count}`
    // );
  }
}
